...
public interface IAccountService
{
    ...
    Task VerifyOwnershipAsync(Guid accountId, Guid userId, CancellationToken cancellationToken = default);
    Task<AccountDto> CreateAccountAsync(Guid userId, CreateAccountRequestDto dto, CancellationToken cancellationToken = default);
    Task DeactivateAccountAsync(Guid accountId, Guid userId, CancellationToken cancellationToken = default);
    Task AdminDeactivateAccountAsync(Guid accountId, CancellationToken cancellationToken = default);
